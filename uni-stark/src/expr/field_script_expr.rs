...
use bitcoin::opcodes::{OP_TOALTSTACK, OP_DROP, OP_FROMALTSTACK};
use primitives::mmcs::tapleaf::Tapleaf;
use core::cell::Cell;
use core::fmt::Debug;
...
impl<F: BfField> FieldScriptExpression<F> {
    fn lookup(self, index: NumScriptExpression, len: usize) -> Self{
...
mod tests {
    ...
    use primitives::field::BfField;
    use scripts::treepp::*;
    use scripts::u31_lib::{u31ext_equalverify, BabyBear4, BabyBearU31, u31_equalverify};

    use super::{Expression, FieldScriptExpression, Variable, *};
    use crate::expr::num_script_expr::NumScriptExpression;
    ...
    fn test_lookup() {
        ...
        let vec = vec![F::from_canonical_u32(1 as u32), F::from_canonical_u32(2 as u32), F::from_canonical_u32(3 as u32), F::from_canonical_u32(4 as u32), F::from_canonical_u32(5 as u32)];
        let mut stack = StackTracker::new();
        let bmap = BTreeMap::new();
